import{_ as l,r as o,o as i,c as p,a as c,d as n,e as s,b as e,f as t}from"./app-pr7VQ2zi.js";const d={},r=t('<h1 id="c-原生接口" tabindex="-1"><a class="header-anchor" href="#c-原生接口" aria-hidden="true">#</a> C++ 原生接口</h1><h2 id="依赖" tabindex="-1"><a class="header-anchor" href="#依赖" aria-hidden="true">#</a> 依赖</h2><ul><li>Java 8+</li><li>Maven 3.5+</li><li>Flex</li><li>Bison 2.7+</li><li>Boost 1.56+</li><li>OpenSSL 1.0+</li><li>GCC 5.5.0+</li></ul><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><h3 id="安装相关依赖" tabindex="-1"><a class="header-anchor" href="#安装相关依赖" aria-hidden="true">#</a> 安装相关依赖</h3>',5),u=t(`<li><p><strong>MAC</strong></p><ol><li><p>安装 Bison ：Mac 环境下预安装了 Bison 2.3 版本，但该版本过低不能够用来编译 Thrift。</p><p>使用 Bison 2.3 版本会报以下错误：<br><code>invalid directive: &#39;%code&#39;</code></p><p>使用下面 brew 命令更新 bison 版本：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>brew <span class="token function">install</span> bison
