import{_ as e,o as i,c as n,a as l,f as t}from"./app-z4N-28Th.js";const s={},a=t(`<h2 id="sql-参考文档" tabindex="-1"><a class="header-anchor" href="#sql-参考文档" aria-hidden="true">#</a> SQL 参考文档</h2><h3 id="显示版本号" tabindex="-1"><a class="header-anchor" href="#显示版本号" aria-hidden="true">#</a> 显示版本号</h3><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">show</span> version
