import{_ as a,r as n,o,c as r,a as s,d as e,e as t,b as l,f as d}from"./app-pr7VQ2zi.js";const c={},h=d(`<h2 id="元数据导出操作" tabindex="-1"><a class="header-anchor" href="#元数据导出操作" aria-hidden="true">#</a> 元数据导出操作</h2><p>元数据导出操作会以 mlog.bin 和 tlog.txt 的形式将当前 IoTDB 中的存储组、时间序列、元数据模板信息进行归档，并导出到指定目录中。</p><p>导出的 mlog.bin 和 tlog.txt 文件可以增量的方式加载到已有元数据的 IoTDB 实例中。</p><h3 id="使用-sql-方式导出元数据" tabindex="-1"><a class="header-anchor" href="#使用-sql-方式导出元数据" aria-hidden="true">#</a> 使用 SQL 方式导出元数据</h3><p>元数据导出的 SQL 语句如下所示：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>EXPORT SCHEMA &#39;&lt;path/dir&gt;&#39; 
