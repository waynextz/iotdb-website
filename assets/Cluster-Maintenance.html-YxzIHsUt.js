import{_ as e,o as n,c as i,a as s,f as d}from"./app-L4eaoWLI.js";const a={},l=d(`<h1 id="集群运维命令" tabindex="-1"><a class="header-anchor" href="#集群运维命令" aria-hidden="true">#</a> 集群运维命令</h1><h2 id="展示集群配置" tabindex="-1"><a class="header-anchor" href="#展示集群配置" aria-hidden="true">#</a> 展示集群配置</h2><p>当前 IoTDB 支持使用如下 SQL 展示集群的关键参数：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>SHOW VARIABLES
