import{_ as n,c as a,b as e,o as i}from"./app-sVi9U6n1.js";const l={};function t(p,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h2 id="go-原生接口" tabindex="-1"><a class="header-anchor" href="#go-原生接口"><span>Go 原生接口</span></a></h2><h3 id="依赖" tabindex="-1"><a class="header-anchor" href="#依赖"><span>依赖</span></a></h3><ul><li>golang &gt;= 1.13</li><li>make &gt;= 3.0</li><li>curl &gt;= 7.1.1</li><li>thrift 0.15.0</li><li>Linux、Macos 或其他类 unix 系统</li><li>Windows+bash(WSL、cygwin、Git Bash)</li></ul><h3 id="安装方法" tabindex="-1"><a class="header-anchor" href="#安装方法"><span>安装方法</span></a></h3><ul><li>通过 go mod</li></ul><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 切换到 GOPATH 的 HOME 路径，启用 Go Modules 功能</span></span>
