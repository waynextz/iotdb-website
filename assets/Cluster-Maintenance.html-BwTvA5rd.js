import{_ as s,r as d,o as l,c as a,b as t,d as e,a as o,w as r,e as n}from"./app-CexV1ZfR.js";const v={},u=n(`<h2 id="集群运维命令" tabindex="-1"><a class="header-anchor" href="#集群运维命令"><span>集群运维命令</span></a></h2><h3 id="展示集群配置" tabindex="-1"><a class="header-anchor" href="#展示集群配置"><span>展示集群配置</span></a></h3><p>当前 IoTDB 支持使用如下 SQL 展示集群的关键参数：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>SHOW VARIABLES
