import{_ as r,r as s,o,c as d,a as c,d as l,e,b as t,w as a,f as i}from"./app-wIgiOADQ.js";const u={},h=i(`<h1 id="元数据操作" tabindex="-1"><a class="header-anchor" href="#元数据操作" aria-hidden="true">#</a> 元数据操作</h1><h2 id="存储组管理" tabindex="-1"><a class="header-anchor" href="#存储组管理" aria-hidden="true">#</a> 存储组管理</h2><h3 id="创建存储组" tabindex="-1"><a class="header-anchor" href="#创建存储组" aria-hidden="true">#</a> 创建存储组</h3><p>我们可以根据存储模型建立相应的存储组。创建存储组支持两种 SQL 语句，如下所示：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB &gt; set storage group to root.ln
