import{_ as e,o as n,c as i,e as s}from"./app-C9SLW7We.js";const l={},a=s(`<h1 id="集群运维命令" tabindex="-1"><a class="header-anchor" href="#集群运维命令"><span>集群运维命令</span></a></h1><h2 id="展示集群配置" tabindex="-1"><a class="header-anchor" href="#展示集群配置"><span>展示集群配置</span></a></h2><p>当前 IoTDB 支持使用如下 SQL 展示集群的关键参数：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>SHOW VARIABLES
