import{_ as r,r as l,o,c,b as t,d as e,a,w as i,e as s}from"./app-DWOe-QN_.js";const u={},v=s(`<h1 id="operate-metadata" tabindex="-1"><a class="header-anchor" href="#operate-metadata"><span>Operate Metadata</span></a></h1><h2 id="database-management" tabindex="-1"><a class="header-anchor" href="#database-management"><span>Database Management</span></a></h2><h3 id="create-database" tabindex="-1"><a class="header-anchor" href="#create-database"><span>Create Database</span></a></h3><p>According to the storage model we can set up the corresponding database. Two SQL statements are supported for creating databases, as follows:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>IoTDB &gt; create database root.ln
