import{_ as i,r as o,o as n,c as r,a as s,d as e,e as t,b as d,f as l}from"./app-OmIqCvOX.js";const c={},h=l(`<h2 id="export-schema" tabindex="-1"><a class="header-anchor" href="#export-schema" aria-hidden="true">#</a> Export Schema</h2><p>The schema export operation exports the information about store group, timeseries, and schema template in the current IoTDB in the form of <code>mlog.bin</code> and <code>tlog.txt</code> to the specified directory.</p><p>The exported <code>mlog.bin</code> and <code>tlog.txt</code> files can be incrementally loaded into an IoTDB instance.</p><h3 id="export-schema-with-sql" tabindex="-1"><a class="header-anchor" href="#export-schema-with-sql" aria-hidden="true">#</a> Export Schema with SQL</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>EXPORT SCHEMA &#39;&lt;path/dir&gt;&#39; 
