import{_ as r,r as l,o,c,a as u,d as a,e,b as s,w as i,f as t}from"./app-wIgiOADQ.js";const m={},v=t(`<h1 id="operate-metadata" tabindex="-1"><a class="header-anchor" href="#operate-metadata" aria-hidden="true">#</a> Operate Metadata</h1><h2 id="database-management" tabindex="-1"><a class="header-anchor" href="#database-management" aria-hidden="true">#</a> Database Management</h2><h3 id="create-database" tabindex="-1"><a class="header-anchor" href="#create-database" aria-hidden="true">#</a> Create Database</h3><p>According to the storage model we can set up the corresponding database. Two SQL statements are supported for creating databases, as follows:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB &gt; create database root.ln
