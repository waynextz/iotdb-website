import{_ as e,o as i,c as t,a as s,f as l}from"./app-OmIqCvOX.js";const n={},o=l(`<h1 id="tsfile-拆分工具" tabindex="-1"><a class="header-anchor" href="#tsfile-拆分工具" aria-hidden="true">#</a> TsFile 拆分工具</h1><p>TsFile 拆分工具用来将一个 TsFile 拆分为多个 TsFile，工具位置为 tools/tsfile/split-tsfile-tool</p><p>使用方式：</p><p>Windows:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.\\split-tsfile-tool.bat &lt;TsFile 文件路径&gt; (-level &lt;新生成文件名的空间内合并次数，默认为10&gt;) (-size &lt;新生成文件的大小（字节），默认为 1048576000&gt;)
