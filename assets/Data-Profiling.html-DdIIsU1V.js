import{_ as p,c as d,d as n,e as s,a as e,w as l,b as i,r as c,o as t}from"./app-B4vJiCQZ.js";const r={},v=i('<h1 id="数据画像" tabindex="-1"><a class="header-anchor" href="#数据画像"><span>数据画像</span></a></h1><h2 id="acf" tabindex="-1"><a class="header-anchor" href="#acf"><span>ACF</span></a></h2><h3 id="函数简介" tabindex="-1"><a class="header-anchor" href="#函数简介"><span>函数简介</span></a></h3>',3),u=n("p",null,[n("strong",null,"函数名："),s(" ACF")],-1),o=n("p",null,[n("strong",null,"输入序列："),s(" 仅支持单个输入序列，类型为 INT32 / INT64 / FLOAT / DOUBLE。")],-1),m=n("strong",null,"输出序列：",-1),b=i(`<p><strong>提示：</strong></p><ul><li>序列中的<code>NaN</code>值会被忽略，在计算中表现为0。</li></ul><h3 id="使用示例" tabindex="-1"><a class="header-anchor" href="#使用示例"><span>使用示例</span></a></h3><p>输入序列：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">+-----------------------------+---------------+</span>
