import{_ as e,o as i,c as t,e as l}from"./app-B-0YFdX2.js";const n={},s=l(`<h2 id="sql-参考文档" tabindex="-1"><a class="header-anchor" href="#sql-参考文档"><span>SQL 参考文档</span></a></h2><h3 id="显示版本号" tabindex="-1"><a class="header-anchor" href="#显示版本号"><span>显示版本号</span></a></h3><div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre class="language-sql"><code><span class="token keyword">show</span> version
