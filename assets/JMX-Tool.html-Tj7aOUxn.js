import{_ as o,r as a,o as s,c as r,a as c,d as e,e as i,b as d,f as t}from"./app-OmIqCvOX.js";const l={},h=t(`<h1 id="jmx-工具" tabindex="-1"><a class="header-anchor" href="#jmx-工具" aria-hidden="true">#</a> JMX 工具</h1><p>Java VisualVM 提供了一个可视化的界面，用于查看 Java 应用程序在 Java 虚拟机（JVM）上运行的详细信息，并对这些应用程序进行故障排除和分析。</p><h2 id="使用" tabindex="-1"><a class="header-anchor" href="#使用" aria-hidden="true">#</a> 使用</h2><p>第一步：获得 IoTDB-server。</p><p>第二步：编辑配置文件</p><ul><li><p>IoTDB 在本地<br> 查看<code>$IOTDB_HOME/conf/jmx.password</code>，使用默认用户或者在此添加新用户<br> 若新增用户，编辑<code>$IOTDB_HOME/conf/jmx.access</code>，添加新增用户权限</p></li><li><p>IoTDB 不在本地<br> 编辑<code>$IOTDB_HOME/conf/datanode-env.sh</code><br> 修改以下参数：</p></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>JMX_LOCAL=&quot;false&quot;
