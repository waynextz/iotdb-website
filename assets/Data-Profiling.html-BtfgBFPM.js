import{_ as r,r as l,o as u,c,b as e,d as n,a as s,w as t,e as i}from"./app-_RQXaIUv.js";const o={},v=i('<h1 id="data-profiling" tabindex="-1"><a class="header-anchor" href="#data-profiling"><span>Data Profiling</span></a></h1><h2 id="acf" tabindex="-1"><a class="header-anchor" href="#acf"><span>ACF</span></a></h2><h3 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h3>',3),p=e("br",null,null,-1),m=e("br",null,null,-1),b=e("p",null,[e("strong",null,"Name:"),n(" ACF")],-1),h=e("p",null,[e("strong",null,"Input Series:"),n(" Only support a single input numeric series. The type is INT32 / INT64 / FLOAT / DOUBLE.")],-1),g=e("strong",null,"Output Series:",-1),T=e("br",null,null,-1),x=i(`<p><strong>Note:</strong></p><ul><li><code>null</code> and <code>NaN</code> values in the input series will be ignored and treated as 0.</li></ul><h3 id="examples" tabindex="-1"><a class="header-anchor" href="#examples"><span>Examples</span></a></h3><p>Input series:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>+-----------------------------+---------------+
...
+-----------------------------+-----------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="qlb" tabindex="-1"><a class="header-anchor" href="#qlb"><span>QLB</span></a></h2><h3 id="usage-14" tabindex="-1"><a class="header-anchor" href="#usage-14"><span>Usage</span></a></h3><p>This function is used to calculate Ljung-Box statistics $Q_{LB}$ for time series, and convert it to p value.</p><p><strong>Name:</strong> QLB</p><p><strong>Input Series:</strong> Only support a single input series. The type is INT32 / INT64 / FLOAT / DOUBLE.</p><p><strong>Parameters</strong>:</p><p><code>lag</code>: max lag to calculate. Legal input shall be integer from 1 to n-2, where n is the sample number. Default value is n-2.</p><p><strong>Output Series:</strong> Output a single series. The type is DOUBLE. The output series is p value, and timestamp means lag.</p><p><strong>Note:</strong> If you want to calculate Ljung-Box statistics $Q_{LB}$ instead of p value, you may use ACF function.</p><h3 id="examples-14" tabindex="-1"><a class="header-anchor" href="#examples-14"><span>Examples</span></a></h3><h4 id="using-default-parameter" tabindex="-1"><a class="header-anchor" href="#using-default-parameter"><span>Using Default Parameter</span></a></h4><p>Input series:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>+-----------------------------+---------------+
|                         Time|root.test.d1.s1|
+-----------------------------+---------------+
...
|2021-03-06T17:00:00.000+08:00|                                                     3.4100000858306885|
+-----------------------------+-----------------------------------------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="sample" tabindex="-1"><a class="header-anchor" href="#sample"><span>Sample</span></a></h2><h3 id="usage-16" tabindex="-1"><a class="header-anchor" href="#usage-16"><span>Usage</span></a></h3>`,278),k=e("br",null,null,-1),f=e("br",null,null,-1),q=e("br",null,null,-1),y=e("strong",null,"Reservoir sampling",-1),w=e("br",null,null,-1),O=e("br",null,null,-1),N=e("strong",null,"Isometric sampling",-1),I=e("br",null,null,-1),L=e("strong",null,"Triangle sampling",-1),S=e("br",null,null,-1),E=e("br",null,null,-1),U={href:"http://skemman.is/stream/get/1946/15343/37285/3/SS_MSthesis.pdf",target:"_blank",rel:"noopener noreferrer"},D=i(`<p><strong>Name:</strong> SAMPLE</p><p><strong>Input Series:</strong> Only support a single input series. The type is arbitrary.</p><p><strong>Parameters:</strong></p><ul><li><code>method</code>: The method of sampling, which is &#39;reservoir&#39;, &#39;isometric&#39; or &#39;triangle&#39;. By default, reservoir sampling is used.</li><li><code>k</code>: The number of sampling, which is a positive integer. By default, it&#39;s 1.</li></ul><p><strong>Output Series:</strong> Output a single series. The type is the same as the input. The length of the output series is <code>k</code>. Each data point in the output series comes from the input series.</p><p><strong>Note:</strong> If <code>k</code> is greater than the length of input series, all data points in the input series will be output.</p><h3 id="examples-16" tabindex="-1"><a class="header-anchor" href="#examples-16"><span>Examples</span></a></h3><h4 id="reservoir-sampling" tabindex="-1"><a class="header-anchor" href="#reservoir-sampling"><span>Reservoir Sampling</span></a></h4><p>When <code>method</code> is &#39;reservoir&#39; or the default, reservoir sampling is used.<br> Due to the randomness of this method, the output series shown below is only a possible result.</p><p>Input series:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>+-----------------------------+---------------+
|                         Time|root.test.d1.s1|
+-----------------------------+---------------+
...
|1970-01-01T08:00:03.200+08:00|                                10.0|
+-----------------------------+------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="skew" tabindex="-1"><a class="header-anchor" href="#skew"><span>Skew</span></a></h2><h3 id="usage-18" tabindex="-1"><a class="header-anchor" href="#usage-18"><span>Usage</span></a></h3><p>This function is used to calculate the population skewness.</p><p><strong>Name:</strong> SKEW</p><p><strong>Input Series:</strong> Only support a single input series. The type is INT32 / INT64 / FLOAT / DOUBLE.</p><p><strong>Output Series:</strong> Output a single series. The type is DOUBLE. There is only one data point in the series, whose timestamp is 0 and value is the population skewness.</p><p><strong>Note:</strong> Missing points, null points and <code>NaN</code> in the input series will be ignored.</p><h3 id="examples-18" tabindex="-1"><a class="header-anchor" href="#examples-18"><span>Examples</span></a></h3><p>Input series:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>+-----------------------------+---------------+
|                         Time|root.test.d1.s1|
+-----------------------------+---------------+
|2020-01-01T00:00:00.000+08:00|            1.0|
|2020-01-01T00:00:01.000+08:00|            2.0|
...
+-----------------------------+-----------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="spline" tabindex="-1"><a class="header-anchor" href="#spline"><span>Spline</span></a></h2><h3 id="usage-19" tabindex="-1"><a class="header-anchor" href="#usage-19"><span>Usage</span></a></h3><p>This function is used to calculate cubic spline interpolation of input series.</p><p><strong>Name:</strong> SPLINE</p><p><strong>Input Series:</strong> Only support a single input series. The type is INT32 / INT64 / FLOAT / DOUBLE.</p><ul><li><code>points</code>: Number of resampling points.</li></ul><p><strong>Output Series:</strong> Output a single series. The type is DOUBLE.</p><p><strong>Note</strong>: Output series retains the first and last timestamps of input series. Interpolation points are selected at equal intervals. The function tries to calculate only when there are no less than 4 points in input series.</p><h3 id="examples-19" tabindex="-1"><a class="header-anchor" href="#examples-19"><span>Examples</span></a></h3><h4 id="assigning-number-of-interpolation-points" tabindex="-1"><a class="header-anchor" href="#assigning-number-of-interpolation-points"><span>Assigning number of interpolation points</span></a></h4><p>Input series:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>+-----------------------------+------------+
|                         Time|root.test.s1|
+-----------------------------+------------+
...
+-----------------------------+-----------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="stddev" tabindex="-1"><a class="header-anchor" href="#stddev"><span>Stddev</span></a></h2><h3 id="usage-21" tabindex="-1"><a class="header-anchor" href="#usage-21"><span>Usage</span></a></h3><p>This function is used to calculate the population standard deviation.</p><p><strong>Name:</strong> STDDEV</p><p><strong>Input Series:</strong> Only support a single input series. The type is INT32 / INT64 / FLOAT / DOUBLE.</p><p><strong>Output Series:</strong> Output a single series. The type is DOUBLE. There is only one data point in the series, whose timestamp is 0 and value is the population standard deviation.</p><p><strong>Note:</strong> Missing points, null points and <code>NaN</code> in the input series will be ignored.</p><h3 id="examples-21" tabindex="-1"><a class="header-anchor" href="#examples-21"><span>Examples</span></a></h3><p>Input series:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>+-----------------------------+---------------+
|                         Time|root.test.d1.s1|
+-----------------------------+---------------+
|2020-01-01T00:00:00.000+08:00|            1.0|
|2020-01-01T00:00:01.000+08:00|            2.0|
...
+-----------------------------+-----------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="zscore" tabindex="-1"><a class="header-anchor" href="#zscore"><span>ZScore</span></a></h2><h3 id="usage-22" tabindex="-1"><a class="header-anchor" href="#usage-22"><span>Usage</span></a></h3><p>This function is used to standardize the input series with z-score.</p><p><strong>Name:</strong> ZSCORE</p><p><strong>Input Series:</strong> Only support a single input series. The type is INT32 / INT64 / FLOAT / DOUBLE.</p><ul><li><code>compute</code>: When set to &quot;batch&quot;, anomaly test is conducted after importing all data points; when set to &quot;stream&quot;, it is required to provide mean and standard deviation. The default method is &quot;batch&quot;.</li><li><code>avg</code>: Mean value when method is set to &quot;stream&quot;.</li><li><code>sd</code>: Standard deviation when method is set to &quot;stream&quot;.</li></ul><p><strong>Output Series:</strong> Output a single series. The type is DOUBLE.</p><h3 id="examples-22" tabindex="-1"><a class="header-anchor" href="#examples-22"><span>Examples</span></a></h3><h4 id="batch-computing-2" tabindex="-1"><a class="header-anchor" href="#batch-computing-2"><span>Batch computing</span></a></h4><p>Input series:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>+-----------------------------+------------+
|                         Time|root.test.s1|
+-----------------------------+------------+
|1970-01-01T08:00:00.100+08:00|         0.0|
|1970-01-01T08:00:00.200+08:00|         0.0|
