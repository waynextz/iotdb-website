import{_ as e,o as i,c as t,a as o,f as s}from"./app-L4eaoWLI.js";const l={},n=s(`<h1 id="tsfile-split-tool" tabindex="-1"><a class="header-anchor" href="#tsfile-split-tool" aria-hidden="true">#</a> TsFile Split Tool</h1><p>IoTDB version 0.12 could produce large files, which leads to difficulties in maintenance. Therefore, since version 0.12.5 and 0.13, TsFile split tool is provided. The split tool can split the large TsFile into several small TsFile according to the configuration.</p><p>After building the server, the startup script of this tool will appear under the <code>server\\target\\iotdb-server-{version}\\tools\\tsfileToolSet</code> directory.</p><p>Command:</p><p>For Windows:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.\\split-tsfile-tool.bat &lt;path of your TsFile&gt; (-level &lt;LEVEL of the target files&gt;) (-size &lt;SIZE of the target files&gt;)
