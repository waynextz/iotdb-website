import{_ as p,c as t,d as n,e as s,a,w as i,b as l,r as d,o as r}from"./app-DKNMC49B.js";const c={},u=l('<h1 id="data-profiling" tabindex="-1"><a class="header-anchor" href="#data-profiling"><span>Data Profiling</span></a></h1><h2 id="acf" tabindex="-1"><a class="header-anchor" href="#acf"><span>ACF</span></a></h2><h3 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h3>',3),o=n("br",null,null,-1),v=n("br",null,null,-1),m=n("p",null,[n("strong",null,"Name:"),s(" ACF")],-1),b=n("p",null,[n("strong",null,"Input Series:"),s(" Only support a single input numeric series. The type is INT32 / INT64 / FLOAT / DOUBLE.")],-1),h=n("strong",null,"Output Series:",-1),g=n("br",null,null,-1),T=l(`<p><strong>Note:</strong></p><ul><li><code>null</code> and <code>NaN</code> values in the input series will be ignored and treated as 0.</li></ul><h3 id="examples" tabindex="-1"><a class="header-anchor" href="#examples"><span>Examples</span></a></h3><p>Input series:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">+-----------------------------+---------------+</span>
