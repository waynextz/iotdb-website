import{_ as s,r as i,o as t,c as l,a as o,d as e,e as n,b as r,f as c}from"./app-1A4W01qe.js";const d={},p=e("h1",{id:"go-native-api",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#go-native-api","aria-hidden":"true"},"#"),n(" Go Native API")],-1),m={href:"https://github.com/apache/iotdb-client-go/",target:"_blank",rel:"noopener noreferrer"},u=c(`<h2 id="dependencies" tabindex="-1"><a class="header-anchor" href="#dependencies" aria-hidden="true">#</a> Dependencies</h2><ul><li>golang &gt;= 1.13</li><li>make &gt;= 3.0</li><li>curl &gt;= 7.1.1</li><li>thrift 0.15.x</li><li>Linux、Macos or other unix-like systems</li><li>Windows+bash (WSL、cygwin、Git Bash)</li></ul><h2 id="installation" tabindex="-1"><a class="header-anchor" href="#installation" aria-hidden="true">#</a> Installation</h2><ul><li>go mod</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">export</span> <span class="token assign-left variable">GO111MODULE</span><span class="token operator">=</span>on
