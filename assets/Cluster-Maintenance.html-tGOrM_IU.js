import{_ as s,r as d,o as l,c as a,a as o,d as t,e,b as r,w as v,f as n}from"./app-pr7VQ2zi.js";const u={},c=n(`<h2 id="集群运维命令" tabindex="-1"><a class="header-anchor" href="#集群运维命令" aria-hidden="true">#</a> 集群运维命令</h2><h3 id="展示集群配置" tabindex="-1"><a class="header-anchor" href="#展示集群配置" aria-hidden="true">#</a> 展示集群配置</h3><p>当前 IoTDB 支持使用如下 SQL 展示集群的关键参数：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>SHOW VARIABLES
