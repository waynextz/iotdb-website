import{_ as o,r as i,o as c,c as p,a as l,d as s,e as n,b as e,f as t}from"./app-z4N-28Th.js";const r={},d=s("h1",{id:"docker部署",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#docker部署","aria-hidden":"true"},"#"),n(" docker部署")],-1),u={href:"https://hub.docker.com/r/apache/iotdb",target:"_blank",rel:"noopener noreferrer"},k=s("br",null,null,-1),v=t(`<h2 id="docker镜像安装-单机版" tabindex="-1"><a class="header-anchor" href="#docker镜像安装-单机版" aria-hidden="true">#</a> docker镜像安装（单机版）</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 获取镜像</span>
