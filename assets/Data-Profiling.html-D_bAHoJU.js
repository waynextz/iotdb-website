import{_ as d,c,b as i,d as a,e as n,a as l,w as p,r,o as t}from"./app-pq_PkUHR.js";const v={};function u(o,s){const e=r("RouteLink");return t(),c("div",null,[s[7]||(s[7]=i('<h2 id="数据画像" tabindex="-1"><a class="header-anchor" href="#数据画像"><span>数据画像</span></a></h2><h3 id="acf" tabindex="-1"><a class="header-anchor" href="#acf"><span>ACF</span></a></h3><h4 id="函数简介" tabindex="-1"><a class="header-anchor" href="#函数简介"><span>函数简介</span></a></h4>',3)),a("p",null,[s[1]||(s[1]=n("本函数用于计算时间序列的自相关函数值，即序列与自身之间的互相关函数，详情参见")),l(e,{to:"/zh/UserGuide/V1.1.x/Operators-Functions/Data-Matching.html#XCorr"},{default:p(()=>s[0]||(s[0]=[n("XCorr")])),_:1}),s[2]||(s[2]=n("函数文档。"))]),s[8]||(s[8]=a("p",null,[a("strong",null,"函数名："),n(" ACF")],-1)),s[9]||(s[9]=a("p",null,[a("strong",null,"输入序列："),n(" 仅支持单个输入序列，类型为 INT32 / INT64 / FLOAT / DOUBLE。")],-1)),a("p",null,[s[4]||(s[4]=a("strong",null,"输出序列：",-1)),s[5]||(s[5]=n(" 输出单个序列，类型为 DOUBLE。序列中共包含$2N-1$个数据点，每个值的具体含义参见")),l(e,{to:"/zh/UserGuide/V1.1.x/Operators-Functions/Data-Matching.html#XCorr"},{default:p(()=>s[3]||(s[3]=[n("XCorr")])),_:1}),s[6]||(s[6]=n("函数文档。"))]),s[10]||(s[10]=i(`<p><strong>提示：</strong></p><ul><li>序列中的<code>NaN</code>值会被忽略，在计算中表现为0。</li></ul><h4 id="使用示例" tabindex="-1"><a class="header-anchor" href="#使用示例"><span>使用示例</span></a></h4><p>输入序列：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">+-----------------------------+---------------+</span>
