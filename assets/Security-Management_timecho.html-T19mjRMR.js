import{_ as e,o as i,c as n,a as t,f as a}from"./app-OmIqCvOX.js";const o={},r=a(`<h1 id="securitymanagement" tabindex="-1"><a class="header-anchor" href="#securitymanagement" aria-hidden="true">#</a> SecurityManagement</h1><h2 id="white-list" tabindex="-1"><a class="header-anchor" href="#white-list" aria-hidden="true">#</a> White List</h2><p><strong>function description</strong></p><p>Allow which client addresses can connect to IoTDB</p><p><strong>configuration file</strong></p><p>conf/iotdb-common.properties</p><p>conf/white.list</p><p><strong>configuration item</strong></p><p>iotdb-common.properties:</p><p>Decide whether to enable white list</p><div class="language-YAML line-numbers-mode" data-ext="YAML"><pre class="language-YAML"><code>
