import{_ as s,c as n,b as a,o as l}from"./app-DVrutTws.js";const i={};function t(r,e){return l(),n("div",null,e[0]||(e[0]=[a(`<h1 id="sql-参考文档" tabindex="-1"><a class="header-anchor" href="#sql-参考文档"><span>SQL 参考文档</span></a></h1><h2 id="显示版本号" tabindex="-1"><a class="header-anchor" href="#显示版本号"><span>显示版本号</span></a></h2><div class="language-sql line-numbers-mode" data-highlighter="prismjs" data-ext="sql" data-title="sql"><pre><code><span class="line"><span class="token keyword">show</span> version</span>
