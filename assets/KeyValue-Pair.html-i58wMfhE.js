import{_ as n,o as s,c as a,a as e,f as t}from"./app-1A4W01qe.js";const p={},o=t(`<h2 id="键值对" tabindex="-1"><a class="header-anchor" href="#键值对" aria-hidden="true">#</a> 键值对</h2><p><strong>键值对的键和值可以被定义为标识符或者常量。</strong></p><p>下面将介绍键值对的使用场景。</p><ul><li>触发器中表示触发器属性的键值对。参考示例语句中 WITH 后的属性键值对。</li></ul><div class="language-SQL line-numbers-mode" data-ext="SQL"><pre class="language-SQL"><code># 以字符串形式表示键值对
