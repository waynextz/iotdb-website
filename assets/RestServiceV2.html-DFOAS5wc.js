import{_ as l,r as o,o as i,c as p,b as s,d as n,a as t,e as a}from"./app-Ccu6TdEz.js";const u={},r=a(`<h1 id="restful-services" tabindex="-1"><a class="header-anchor" href="#restful-services"><span>RESTful Services</span></a></h1><p>IoTDB&#39;s RESTful services can be used for query, write, and management operations, using the OpenAPI standard to define interfaces and generate frameworks.</p><h2 id="enable-restful-services" tabindex="-1"><a class="header-anchor" href="#enable-restful-services"><span>Enable RESTful Services</span></a></h2><p>RESTful services are disabled by default.</p><ul><li><p>Developer</p><p>Find the <code>IoTDBrestServiceConfig</code> class under <code>org.apache.iotdb.db.conf.rest</code> in the sever module, and modify <code>enableRestService=true</code>.</p></li><li><p>User</p><p>Find the <code>conf/iotdb.rest.properties</code> file under the IoTDB installation directory and set <code>enable_rest_service</code> to <code>true</code> to enable the module.</p><div class="language-properties line-numbers-mode" data-ext="properties" data-title="properties"><pre class="language-properties"><code><span class="token key attr-name">enable_rest_service</span><span class="token punctuation">=</span><span class="token value attr-value">true</span>
